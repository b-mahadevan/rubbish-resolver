...
print("Model converted and saved as waste_classification.tflite")

converter.target_spec.supported_types = [tf.float16]

tflite_model_quant = converter.convert()
with open("Waste_Classification_Quant.tflite", "wb") as f:
    f.write(tflite_model_quant)

print("Quantized TFLite model saved as waste_classification_quant.tflite")